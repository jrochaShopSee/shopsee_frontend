...
import { AddEditAddressViewModel, AddressFormData } from "@/app/types/Profile";
...
const AddAddressPage: React.FC = () => {
    ...
    useEffect(() => {
        const loadFormData = async () => {
            try {
                const data = await profileApi.getAddressFormData();
                setFormData(data);
            } catch (err) {
        ...
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600">Create a new address for your profile</p>
                </div>
            </div>
