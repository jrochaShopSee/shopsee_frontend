...
import { CreateStateRequest } from "@/app/types/Role";
import { toast } from "react-toastify";
import { LoadingSpinner } from "@/app/components/shared/LoadingSpinner";
import { ArrowLeft, MapPin, AlertTriangle } from "lucide-react";

interface AddStatePageProps {
    countryId: string;
}

const AddStatePage: React.FC<AddStatePageProps> = ({ countryId }) => {
    ...
    useEffect(() => {
        const loadCountry = async () => {
            try {
                const country = await settingsApi.getCountryById(parseInt(countryId));
    ...
    const onSubmit = async (data: CreateStateRequest) => {
        setSubmitting(true);
        try {
            await settingsApi.createState(data);
        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="mb-6">
                ...
                <h1 className="text-3xl font-bold text-gray-900 mb-2">
                    Add State to {countryName}
                </h1>
                <p className="text-gray-600">Create a new state or province</p>
            </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">
                                Enter the state or province details
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Enter state or province name (e.g., California)"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Enter abbreviation (e.g., CA, ON, NSW)"
                            maxLength={10}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                        {errors.abbreviation && (
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Enter display order (0 for default)"
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                        <p className="mt-2 text-sm text-gray-500">
