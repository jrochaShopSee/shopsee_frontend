...
import { CreateCountryRequest } from "@/app/types/Role";
...
const AddCountryPage: React.FC = () => {
    ...
    const onSubmit = async (data: CreateCountryRequest) => {
        setSubmitting(true);
        try {
            await settingsApi.createCountry(data);
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600">Create a new country for shipping and addressing</p>
            </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Enter abbreviation (e.g., US, CA, UK)"
                            maxLength={10}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                        {errors.abbr && (
