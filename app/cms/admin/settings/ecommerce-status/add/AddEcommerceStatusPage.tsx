...
export default function AddEcommerceStatusPage() {
    ...
    const onSubmit = async (data: EcommerceStatusFormData) => {
        ...
        try {
            const result = await settingsApi.createEcommerceStatus(data);
            ...
            const errorMessage = error && typeof error === 'object' && 'response' in error
                ...
                : undefined;
            toast.error(errorMessage || "Failed to create status");
        } finally {
                ...
                <div className="mb-6">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-100">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">Add Ecommerce Status</h1>
                                <p className="text-sm text-gray-600 mt-1">
                                    Create a new order status with email notification settings
                                </p>
                            </div>
                        </div>
                    </div>
